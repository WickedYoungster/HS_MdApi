...
SOURCEFILES := HengShengMdApi.cpp main_environment.cpp main_message_queue.cpp MyAutoLock.cpp MyEvent.cpp MyThread.cpp sdk_callback.cpp sdk_data_parser.cpp sdk_util.cpp stock_MdApi.cpp
EXTERNAL_LIBS := 
